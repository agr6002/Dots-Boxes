...
{
  board.playerColors.push_back(Color {255, 0, 255, 255});
  board.playerColors.push_back(Color {0, 0, 0, 255});
}
...
void Game::RunController()
{
  ...
  while (SDL_PollEvent(&event))
  {
    ...
    case SDL_MOUSEMOTION:
      board.mouseMotionX = event.motion.x;
      board.mouseMotionY = event.motion.y;
      break;
    }
  }
